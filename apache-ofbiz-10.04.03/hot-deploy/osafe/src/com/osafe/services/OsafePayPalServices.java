...
/**
 * OsafePayPalServices for NVP API communication
 */
public class OsafePayPalServices {

    public static final String module = OsafePayPalServices.class.getName();
    ...
    public static Map<String, Object> setExpressCheckout(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        if (!cart.shippingApplies()) {
            ...
            //These are used in conjunction with the Shipping Call back URL. commentted by Len for our implementation
//            encoder.add("CALLBACK", payPalConfig.getString("shippingCallbackUrl"));
//            encoder.add("CALLBACKTIMEOUT", "6");
//            encoder.add("L_SHIPPINGOPTIONISDEFAULT0", "true");
//            encoder.add("L_SHIPPINGOPTIONNAME0", "Calculated Offline");
//            encoder.add("L_SHIPPINGOPTIONAMOUNT0", "0.00");
        ...
        try {
            ...
            // Len commented this line for our implementation
            /*return ServiceUtil.returnError(UtilProperties.getMessage(resource, 
                    "AccountingPayPalErrorDuringRetrievingCartDetails", locale));*/
            return ServiceUtil.returnError("An error occurred while retreiving cart details"); // Len added this line for our implementation 
        }
        ...
        if (UtilValidate.isNotEmpty(errorMessages)) {
            if (errorMessages.containsKey("10411")) {
                ...
                return OsafePayPalServices.setExpressCheckout(dctx, context);
            }
        ...
        OsafePayPalServices.tokenCartMap.put(tokenWrapper, new WeakReference<ShoppingCart>(cart));
...
/*            return ServiceUtil.returnError(UtilProperties.getMessage(resource, 
        ...
        String countryGeoId = OsafePayPalServices.getCountryGeoIdFromGeoCode(decoder.get("SHIPTOCOUNTRYCODE"), delegator);
