...
<#if partyShippingContactMechValueMap?has_content>

    <#assign contactMech = partyShippingContactMechValueMap.contactMech?if_exists />
    <#assign contactMechType = partyShippingContactMechValueMap.contactMechType?if_exists />
    <#assign partyContactMech = partyShippingContactMechValueMap.partyContactMech?if_exists />
    <#-- Start Addresses -->
   ...
   <div class="infoEntry">
    ...
    <div class="infoRow">
      <div class="infoEntry">
         ...
         <div class="infoValue">
            <#assign postalAddress = partyShippingContactMechValueMap.postalAddress>
